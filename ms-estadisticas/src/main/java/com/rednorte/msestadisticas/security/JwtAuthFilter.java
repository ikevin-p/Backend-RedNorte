 ...
 *
 * Nota: aunque este microservicio tiene spring-boot-starter-webflux en el
 * classpath (usado solo para WebClient), su contexto de aplicacion sigue
 * siendo Servlet/MVC tradicional (por spring-boot-starter-web), por lo
 * que OncePerRequestFilter es correcto aqui.
 */
@Component
